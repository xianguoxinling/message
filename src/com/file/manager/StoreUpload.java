...
//	static Logger logger = LogManager.getLogger();
	...
	{
	    uploadProductionPic(request,response);
	}
	...
	public void uploadProductionPic(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException
	{
        ...
        List<String> data = new ArrayList<String>();
	       ...
	       String filePath = "/srv/www/htdocs/ty/rich/store/";
